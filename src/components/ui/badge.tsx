  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-[hsl(var(--ring))] focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-[hsl(var(--success))]/15 text-[hsl(var(--success))] border-[hsl(var(--success))]/30",
        warning:
          "border-transparent bg-[hsl(var(--warning))]/15 text-[hsl(var(--warning))] border-[hsl(var(--warning))]/30",
        error:
          "border-transparent bg-[hsl(var(--error))]/15 text-[hsl(var(--error))] border-[hsl(var(--error))]/30",
        info:
          "border-transparent bg-[hsl(var(--info))]/15 text-[hsl(var(--info))] border-[hsl(var(--info))]/30",
      },
    },
    defaultVariants: {
      variant: "default",
